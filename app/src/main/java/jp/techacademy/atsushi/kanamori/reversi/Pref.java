...
public class Pref extends PreferenceActivity {
    ...
    public static String getState(Context con) {
        String value = PreferenceManager.getDefaultSharedPreferences(con).getString(KEY_STATE, "");
        return value;
    }
    ...
    public static String getPlayer1(Context con) {
        String value = PreferenceManager.getDefaultSharedPreferences(con).getString(KEY_PLAYER1, con.getString(R.string.pref_player1_default));
        return value;
    }
    ...
    public static String getPlayer1Name(Context con) {
        String value = PreferenceManager.getDefaultSharedPreferences(con).getString(KEY_PLAYER1_NAME, con.getString(R.string.pref_player1_name_default));
        return value;
    }
    ...
    public static String getPlayer2(Context con) {
        String value = PreferenceManager.getDefaultSharedPreferences(con).getString(KEY_PLAYER2, con.getString(R.string.pref_player1_default));
        return value;
    }
    ...
    public static String getPlayer2Name(Context con) {
        String value = PreferenceManager.getDefaultSharedPreferences(con).getString(KEY_PLAYER2_NAME, con.getString(R.string.pref_player1_name_default));
        return value;
    }
